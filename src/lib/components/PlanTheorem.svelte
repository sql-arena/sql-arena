...
<table class="data">
	<thead>
	<tr>
		<th rowspan="2" class="text">Engine</th>
	...
	<tbody>
		...
		<tr>
			<td class="grouped"><img class="table-logo" src="/img/logo-dark/{engine}.png"/>{engine}</td>
